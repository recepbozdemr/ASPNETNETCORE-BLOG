...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        ...
        {
            builder.HasKey(a => a.Id); //Birincil anahtar
            builder.Property(a => a.Id).ValueGeneratedOnAdd(); //Bir bir artıcak
            builder.Property(a => a.Title).HasMaxLength(100);
            builder.Property(a => a.Title).IsRequired(true); //Zorunlumu değilmi?
            ...
            builder.Property(a => a.CreatedByName).HasMaxLength(500);
            builder.HasOne<Category>(a=>a.Category).WithMany(c=>c.Articles).HasForeignKey(a=>a.CategoryId);
            builder.HasOne<User>(a => a.User).WithMany(c => c.Articles).HasForeignKey(a => a.UserId);
            //Bir kategorinin birden fazla makelesi olabilir
